const { deleteCartItem } = require("../controllers/cart.controller");
...
describe("deleteCartItem controller", () => {
  ...
  it("should remove the item from cart and return updated cart", async () => {
    const mockCart = {
      items: [
    ...
    expect(mockCart.items[0].productId.toString()).toBe("anotherProd");
